    ...
    <header className="app-header">
      <div className="header-inner">
        <div className="brand-crest">
          ...
          <span className="brand-badge">EST. 2010 • KERALA TRADITION</span>
          <span className="crest-symbol">✦</span>
        </div>
        ...
        <p className="brand-subtitle">PREMIUM CATERING • INCOME & EXPENSE NOTE</p>
        ...
        <div className="header-actions no-print">
          <button
            ...
            onClick={onLoadDemo}
            className="btn-demo"
            title="Load sample 'Rahul Wedding' data to test calculations instantly"
          >
